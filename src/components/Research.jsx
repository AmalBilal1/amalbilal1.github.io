...
const researchData = [
  ...
  },
  {
    ...
    type: "Inspirit AI Scholars Program",
    description: "Build and compared Decision Tree, K-Nearest Neighbors (KNN), and Convolutional Neural Network (CNN) models to predict whether chest X-ray images indicate having pneumonia. Applied targeted data augmentation techniques to address enhance CNN generalization and improve model generalization.",
    ...
    achievements: ["Estimated model performance metrics for each algorithm.", "Demonstrated that augmentation materially improved CNN performance and robustness versus non-augmented runs.", "Presented results and methodology to MIT and Stanford mentors as well as fellow scholars."],
    tools: ["Python", "NumPy", "Pandas", "Scikit-learn", "Matplotlib", "Keras", "TensorFlow"],
    status: "Presented",
